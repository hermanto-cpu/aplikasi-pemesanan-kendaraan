                    ...
                    <form method="POST" action="/dashboard/store">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="supervisor_id" name="supervisor_id" required>
                                <option value="" selected disabled>Pilih Approver Level 1</option>
                                @foreach ($supervisor as $approver)
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="supervisor_id_2" name="supervisor_id_2" required>
                                <option value="" selected disabled>Pilih Approver Level 2</option>
                                @foreach ($supervisor as $approver)
                                    <option value="{{ $approver->id }}">{{ $approver->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="kendaraan" name="kendaraan" required>
                                <option value="Dump Truck" selected disabled>Pilih Kendaraan</option>
                                    <option value="Dump Truck">Dump Truck</option>
                                    <option value="Articulated Hauler">Articulated Hauler</option>
                                    <option value="Rock Truck">Rock Truck</option>
                            </select>
                        </div>
